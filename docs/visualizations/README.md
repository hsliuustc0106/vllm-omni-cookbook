...
| [served on the blog](https://hsliuustc0106.github.io/vllm-omni-cookbook/assets/figures/diffusion-sequence-parallelism/diffusion-sequence-parallelism-design.html) · [source](https://github.com/hsliuustc0106/vllm-omni-cookbook/blob/main/blog/assets/figures/diffusion-sequence-parallelism/diffusion-sequence-parallelism-design.html) | vllm-omni diffusion [sequence-parallelism subsystem](https://github.com/vllm-project/vllm-omni/blob/main/docs/user_guide/diffusion/parallelism/sequence_parallel.md) at main c588208cc — Ulysses · Ring · Hybrid ×Ring · AllGather-KV | 2026-08-17 | analyzed in the [blog post](https://github.com/hsliuustc0106/vllm-omni-cookbook/blob/main/blog/_posts/2026-08-17-understanding-diffusion-sequence-parallelism.md); the blog is its only copy |
