...
| **H200 retro** | 2× H200 (in progress) | [Retro README](https://github.com/vllm-project/vllm-omni/blob/main/benchmark_results/qwen3_omni_retro/README.md) |
...
## H200 retro — v0.18.0 vs v0.20.0

**Protocol:** shared workload on 2× H200 (`CUDA_VISIBLE_DEVICES=2,3`) — text+audio random **2500/900**, `--async-chunk`, deploy profile Thinker GPU0 / Talker+Code2Wav GPU1.
...
- **v0.20→main (`28ce618f`):** TTFP +7%, RTF +18%, throughput −15% — modest regression on this H200 snapshot; #3732 Code2Wav cudagraph not isolated here.

Result files: `v0.18.0/result_*_164613.json` · `v0.20.0/result_*_150548.json` · `main/result_*_163106.json`

### c=10 throughput — unstable on H200 (2026-05-24)
...
- v0.20.0 vs main tag-to-tag on H200
