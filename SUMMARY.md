...
| LTX-2.3    | diffusion  | T2V full-model serving guard              | —                     | tracked; #4956 RMSNorm override validated, formal retro pending |
...
- **LTX-2.3:** Added as a tracked diffusion-video ledger. Current public evidence includes the v0.23-line full-model guard plus v0.24 RMSNorm regression recovery in [#4956](https://github.com/vllm-project/vllm-omni/pull/4956); this is still PR-head watchlist evidence, not a v0.22 release delta. See [index](diffusion/ltx2.3/index.md).
