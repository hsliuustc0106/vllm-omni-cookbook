...
| LTX-2.3    | diffusion  | T2V full-model serving guard              | —                     | tracked; even-release retro pending |
...
- **LTX-2.3:** Added as a tracked diffusion-video ledger. Current public evidence is a v0.23-line full-model guard/watchlist rather than a v0.22 release delta. See [index](diffusion/ltx2.3/index.md).
