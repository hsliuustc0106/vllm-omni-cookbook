...
| LTX-2.3    | diffusion  | T2V full-model serving guard              | —                     | tracked; v0.24 RMSNorm watchlist pending formal retro |
...
- **LTX-2.3:** Added as a tracked diffusion-video ledger. Current public evidence includes the v0.23-line full-model guard plus v0.24 RMSNorm regression triage; this is still watchlist evidence, not a v0.22 release delta. See [index](diffusion/ltx2.3/index.md).
