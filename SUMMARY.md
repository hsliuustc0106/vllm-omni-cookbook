...
- **Qwen-Image:** First retro T2I comparison (v0.16 / v0.18 / v0.20) on 4× L20X; v0.18 ≈ v0.20 on `vllm-omni`. See [index](diffusion/qwen-image/index.md).
...
| Qwen-Image | diffusion  | T2I E2E (1536² single, 4×L20X retro) | **23.96 s** | first retro baseline |
| Qwen-Image | diffusion  | T2I E2E (1536² USP2, 4×L20X retro) | **8.16 s** | first retro baseline |
...
| Qwen-Image | diffusion  | T2I E2E (512², 4×L20X retro) | **1.13 s** ‡ | first retro baseline |
| Qwen-Image | diffusion  | T2I E2E (1536² single, 4×L20X retro) | **15.91 s** ‡ | — |
| Qwen-Image | diffusion  | T2I E2E (1536² USP2, 4×L20X retro) | **12.93 s** §‡ | — |

‡ v0.16 uses `openai` backend + SDPA; not comparable to v0.18/v0.20. § v0.16 USP2 without VAE-pp4 CLI.
...
- **Qwen-Image:** Model available; no upstream perf JSON until v0.18. L20X retro: [index](diffusion/qwen-image/index.md).
